...
connect_debug_port u_ila_0/probe1 [get_nets [list {eth_top_inst/eth_rx_inst/Rxd_IBUF[0]} {eth_top_inst/eth_rx_inst/Rxd_IBUF[1]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 8 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {eth_top_inst/eth_rx_inst/rByte_d1[0]} {eth_top_inst/eth_rx_inst/rByte_d1[1]} {eth_top_inst/eth_rx_inst/rByte_d1[2]} {eth_top_inst/eth_rx_inst/rByte_d1[3]} {eth_top_inst/eth_rx_inst/rByte_d1[4]} {eth_top_inst/eth_rx_inst/rByte_d1[5]} {eth_top_inst/eth_rx_inst/rByte_d1[6]} {eth_top_inst/eth_rx_inst/rByte_d1[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 2 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {eth_top_inst/eth_tx_inst/rTx_Data_d1_reg[1]_0[0]} {eth_top_inst/eth_tx_inst/rTx_Data_d1_reg[1]_0[1]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 4 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[0]} {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[1]} {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[2]} {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 1 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list eth_top_inst/Tx_En_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe6]
set_property port_width 1 [get_debug_ports u_ila_0/probe6]
connect_debug_port u_ila_0/probe6 [get_nets [list eth_top_inst/eth_tx_inst/wFifo_Rd_Valid]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe7]
set_property port_width 1 [get_debug_ports u_ila_0/probe7]
connect_debug_port u_ila_0/probe7 [get_nets [list eth_top_inst/eth_rx_inst/Crc_Valid_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 1 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list eth_top_inst/eth_rx_inst/rByte_Rdy]]
