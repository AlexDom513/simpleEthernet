...
connect_debug_port u_ila_0/probe0 [get_nets [list {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[0]} {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[1]} {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[2]} {eth_top_inst/eth_tx_inst/wTx_Ctrl_FSM_State[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 2 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {eth_top_inst/eth_tx_inst/rTx_Data_d1_reg[1]_0[0]} {eth_top_inst/eth_tx_inst/rTx_Data_d1_reg[1]_0[1]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe3 [get_nets [list eth_top_inst/Tx_En_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list eth_top_inst/eth_tx_inst/wFifo_Rd_Valid]]
